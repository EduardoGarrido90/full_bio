...
for ((i=1;i<=100;i+=1)); do
	...
	sed -i -- "s/\"experiment-name\" : \"simple_ga_branin_ei_1\"/\"experiment-name\" : \"simple_ga_branin_ei_${i}\"/g" experiments/exp_${i}/ga/config.json
	sed -i -- "s/\"experiment-name\" : \"simple_ga_branin_pes_1\"/\"experiment-name\" : \"simple_ga_branin_pes_${i}\"/g" experiments/exp_${i}/pes/config.json
	sed -i -- "s/\"experiment-name\" : \"simple_ga_branin_random_1\"/\"experiment-name\" : \"simple_ga_branin_random_${i}\"/g" experiments/exp_${i}/random/config.json
